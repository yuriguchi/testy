...
from testy.tests_representation.api.v2.serializers import ParameterSerializer
from testy.tests_representation.models import Parameter


@pytest.mark.django_db
class TestParameterEndpoints:
    view_name_list = 'api:v2:parameter-list'
    view_name_detail = 'api:v2:parameter-detail'
