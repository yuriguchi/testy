...
from testy.tests_representation.api.v2.serializers import ResultStatusSerializer
...
class TestResultStatusEndpoints:
    view_name_list = 'api:v2:status-list'
    view_name_detail = 'api:v2:status-detail'
    ...
    @pytest.mark.parametrize('view_name', ('api:v2:testplan-activity-statuses', 'api:v2:testplan-statuses'))
    ...
    def test_get_last_statuses_from_testplan(
        ...
        response_body = api_client.send_request(
            'api:v2:testplan-statuses', reverse_kwargs={'pk': parent_plan.pk},
        ).json()
