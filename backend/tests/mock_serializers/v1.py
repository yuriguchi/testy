...
from testy.tests_description.api.v2.serializers import TestSuiteOutputSerializer
...
class TestSuiteBaseMockSerializer(PathRetrieveMixin, TestSuiteBaseSerializer):
    """V1 implementation"""
...
class TestSuiteMockTreeSerializer(BaseTestSuiteMockOutputSerializer, TestSuiteTreeSerializer):
    """V1 implementation"""
...
class TestSuiteTreeBreadcrumbsMockSerializer(TestSuiteTreeBreadcrumbsSerializer):
    is_used = SerializerMethodField()

    def __init__(self, *args, **kwargs):
        self.suite_ids = kwargs.pop('suite_ids', [])
        super().__init__(*args, **kwargs)

    def get_is_used(self, instance):
        return instance.id in self.suite_ids
