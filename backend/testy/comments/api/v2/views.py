...
from testy.comments.api.v2.serializers import CommentSerializer, InputCommentSerializer
...
from testy.swagger.v2.comments import comment_list_schema
...
class CommentsViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        if self.action not in {'list', 'create'}:
            return CommentSelector.list_comments_by_user(self.request.user)
    ...
    @swagger_auto_schema(responses={status.HTTP_201_CREATED: CommentSerializer()})
